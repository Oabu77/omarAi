...
| `feature-graphic-1024x500.png` | 1,024 × 500, 8-bit RGB with no alpha, 108,518 bytes | `69ef902c5dd47cfc14cadd693f7fcc24e971960b3725ed2e3e8ca63abbaba85b` | Matching white/aqua O mark, “Omar AI,” and “Local plans and business records”; no connected/live-AI, price, award, rank, install prompt, third-party logo, or unbuilt-screen claim |
...
Feature-graphic safe-zone source check: primary text and the translated orbit group stay approximately within `x=142…921` and `y=96…404` on the 1,024 × 500 canvas. Only decorative background shapes extend toward the edges.
...
- Feature graphic: an Omar orbit motif and the current-release message “Local plans and business records.” The capability copy is limited to the disconnected local-first workspace and does not imply connected or live AI.
...
- Feature graphic alt text: `Omar AI ring mark with the words Local plans and business records`
